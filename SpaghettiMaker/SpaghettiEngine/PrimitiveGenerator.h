...
public:
    ...
    static GameObject* CreateCapsule(const char* name, float radius, float height, int segments, int rings);
    static GameObject* CreateTorus(const char* name, float ringRadius, float tubeRadius, int ringSegments, int tubeSegments);
...
private:
    ...
    static void GenerateCapsuleGeometry(std::vector<Vertex>& vertices, std::vector<unsigned int>& indices, float radius, float height, int segments, int rings);
    static void GenerateTorusGeometry(std::vector<Vertex>& vertices, std::vector<unsigned int>& indices, float ringRadius, float tubeRadius, int ringSegments, int tubeSegments);
